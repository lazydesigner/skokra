<div class="private-area-background" id="private-area-background">
    <div class="private-area">
        ...
        <div class="private-area-body">
            <div class="private-area-subheading">Hey! <?php if(isset($_SESSION['email'])){echo $_SESSION['email']; } ?></div>
            <div class="private-area-action">
                ...
                <div class="private-area-items">
                    <a href="<?=get_url() ?>u/account/tokens"><span><i class="ri-database-2-fill"></i><br>Tokens</span></a>
                </div>
                <div class="private-area-items">
